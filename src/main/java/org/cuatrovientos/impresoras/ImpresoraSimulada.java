...
public class ImpresoraSimulada implements Runnable{
	...
	public void run() {
        ...
        // Todas las impresoras del mismo tipo comparten grupo para repartirse el trabajo
        ...
        String topic = (tipo.equals("COLOR")) ? "topic-color" : "topic-bn";
        consumer.subscribe(Collections.singletonList(topic));

        System.out.println("✅ Impresora " + tipo + " [" + id + "] ENCENDIDA en hilo: " + Thread.currentThread().getName());
